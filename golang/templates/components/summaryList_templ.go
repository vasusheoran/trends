...
func SummaryData(data map[string]*contracts.Summary) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"\" hx-ext=\"ws\" ws-connect=\"/ws/ticker\"><div id=\"tickers\">")
		...
		for k, s := range data {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates\components\summaryList.templ`, Line: 13, Col: 11}
			}
